Feature: Add Employee
  ...
  Scenario: Successfully assigning an employee to an activity
    ...
    And an activity with name "UI Design", start date "01/06/2025" and end date "15/06/2025" exists in "WebsiteRedesign"
  ...
  Scenario: Fail to assign employee to activity because too many activities
    ...
    And an activity with name "Backend Refactor", start date "01/06/2025" and end date "30/06/2025" exists in "InternalTool"
  ...
  Scenario: Fail to assign employee who is already assigned to activity
    ...
    And an activity with name "API Integration", start date "01/06/2025" and end date "30/06/2025" exists in "MobileApp"
